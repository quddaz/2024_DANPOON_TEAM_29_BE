    ...
    public void run(ApplicationArguments args) {
        if (postRepository.count() > 0) {
            ...
            Post REAL_POST1 = Post.builder()
                    ...
                    .postImageUrl("https://globalnest.s3.ap-northeast-2.amazonaws.com/post/%EB%8B%A4%EC%9A%B4%EB%A1%9C%EB%93%9C+(1).jfif")
                    .build();
            ...
            Post REAL_POST2 = Post.builder()
                    ...
                    .postImageUrl("https://globalnest.s3.ap-northeast-2.amazonaws.com/post/pngtree-winter-snowman-in-the-snow-royalty-free-image_13196875.jpg")
                    .build();
            ...
            Post REAL_POST3 = Post.builder()
                    ...
                    .postImageUrl("https://globalnest.s3.ap-northeast-2.amazonaws.com/post/images+(1).jfif")
                    .build();
            ...
            Post REAL_POST4 = Post.builder()
                    ...
                    .postImageUrl("https://globalnest.s3.ap-northeast-2.amazonaws.com/post/images.jfif")
                    .build();
            ...
            Post REAL_POST5 = Post.builder()
                    ...
                    .postImageUrl("https://globalnest.s3.ap-northeast-2.amazonaws.com/post/images.png")
                    .build();
            ...
            Post REAL_POST6 = Post.builder()
                    ...
                    .postImageUrl("https://globalnest.s3.ap-northeast-2.amazonaws.com/post/%EB%8B%A4%EC%9A%B4%EB%A1%9C%EB%93%9C+(2).jfif")
                    .build();
            ...
            Post REAL_POST7 = Post.builder()
                    ...
                    .postImageUrl("https://globalnest.s3.ap-northeast-2.amazonaws.com/post/%EB%8B%A4%EC%9A%B4%EB%A1%9C%EB%93%9C.jfif")
                    .build();
            ...
            Post REAL_POST8 = Post.builder()
                    ...
                    .postImageUrl("https://globalnest.s3.ap-northeast-2.amazonaws.com/post/snow-7646952_1280.webp")
                    .build();
